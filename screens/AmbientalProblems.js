...
import AmbientalStory from "./AmbientalStory";

const bgImage = require("../assets/ambiental4.jpg");
var ambientalStory = require("./temp_ambiental.json")
...
export default class AmbientalProblems extends Component {
 ...
 renderItem = ({ item: story }) => {
    return <AmbientalStory story={story} />;
  };
        ...
        return (
            ...
            <SafeAreaView style={styles.droidSafeArea} />
             <ImageBackground source={bgImage} style={styles.bgImage}>
                ...
                <Text style={styles.titleText}>Problemas Ambientales:</Text>
